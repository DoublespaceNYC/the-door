...
const {
  NODE_ENV,
  URL: NETLIFY_SITE_URL = 'https://broomestreetacademy.org/',
...
const config: GatsbyConfig = {
  siteMetadata: {
    title: `The Door`,
    description: `Website for broomestreetacademy.org/ built with DatoCMS, Emotion, and typescript.`,
